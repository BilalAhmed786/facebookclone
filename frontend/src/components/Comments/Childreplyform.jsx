...
const Childreplyform = ({
  ...
  // Auto-resize textarea height smoothly as text changes
  useLayoutEffect(() => {
  ...
  // Handle Enter to submit, Shift+Enter for line break, Escape to cancel
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await axios.post(
        `${backendurl}/api/comments/reply2firstchild`,
        { text: replyText, replyid, commentid, replytomsg, replyto },
