...
const Hoc = (Common) => {
  const Childfunc = () => {
    ...
    const handleReplyfirstchild = async(replyText,replyid,commentid,replytomsg,replyto)=>{
    ...
    const handleReply2Reply = async (replyText,replyid,repliesid,commentid,replytomsg,replyto) => {
