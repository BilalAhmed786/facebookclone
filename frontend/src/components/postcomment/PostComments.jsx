  ...
  return (
    ...
    <div className="relative mb-4 p-4 border rounded shadow-sm">
      ...
      <div className="flex flex-col space-y-2">
        {commentsVisible[post._id] && post.comments.map((comment) => (
          <div key={comment._id} className="flex flex-col space-y-2">
            ...
            {childcommentsVisible[comment._id] && comment.replies.map((reply) => (
              <>
                <div key={reply._id} className="flex items-center space-x-2 ml-8">
                ...
                {childcommentsVisible[reply._id] && reply.replies.map((replies) => (
                  <div key={replies._id} className="flex items-center space-x-2 ml-14">
